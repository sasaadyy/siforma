                ...
                <div class="col-lg-12">
                    ...
                    <div class="table table-responsive mb-3">
                        ...
                        <form action="<?= base_url('home/cart/update_cart') ?>" method="post">
                            <h3 class="text-center mb-3">Recent Booking</h3>
                    ...
                    <div class="row">
                        <div class="col-lg-12 ml-auto mb-3">
                            ...
                            <div class="table table-responsive mt-3">
                                <h3 class="text-center mb-3 mt-3">Success Booking</h3>
                                <form action="<?= base_url('home/cart/update_cart') ?>" method="post">
                                    <table class="table table-bordered">
                                        <thead>
                                            <tr class="text-center">
                                                    ...
                                                    <tr class="text-center">
                                                        ...
                                                        <td>
                                                            <?php if ($order->status == "Closed") { ?>
                                                                <span class="text-success"><i class="fa fa-check-square"></i> &nbsp; <strong>Done!</strong></span>
                                                            <?php } else { ?>
                                                            <?php } ?>
                                                        </td>
                                                        <td>Rp. <?= number_format($order->total, 0, ',', '.'); ?></td>
                    ...
                    <div class="cart-update-option d-block d-md-flex justify-content-between mt-3" style="border: none;">
                        <div class="apply-coupon-wrapper">
                            <a href="<?= base_url('dashboard') ?>" class="btn obrien-button primary-btn">Lanjutkan Belanja</a>
                        </div>
                        <div class="">
