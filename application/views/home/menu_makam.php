    ...
    <div class="row">
        <div class="col-12 text-center">
            <div class="breadcrumb-content position-relative section-content">
                <h3 class="title-3">Menu Makam</h3>
                <ul>
                    ...
                    <div class="col-md-6 col-sm-6 col-lg-4 col-custom product-area">
                        <div class="single-product position-relative">
                            <div class="product-image">
                                        <a class="d-block" href="<?= base_url('dashboard/paket_detail/'.$row->id_zz) ?>">
                                    ...
                                    <div class="product-content">
                                        ...
                                        <div class="product-title">
                                            <h4 class="title-2"> <a href="<?= base_url('dashboard/paket_detail/'.$row->id_paket) ?>"><?= $row->nama_paket ?></a></h4>
                                        </div>
                                        <div class="price-box">
                                    ...
                                    <div class="add-action d-flex position-absolute">
                                        <a href="<?= base_url('home/cart/tambah_cart/'.$row->id_paket) ?>" title="Add To cart">
                                            <i class="ion-bag"></i>
                                        </a>
                                        
                                        <a href="<?= base_url('dashboard/paket_detail/'.$row->id_paket) ?>" data-toggle="modal" title="Quick View">
                                            <i class="ion-eye"></i>
                                        </a>
                            </div>
                            <div class="product-content-listview">
                                ...
                                <div class="price-box">
                                    ...
                                    <span class="regular-price ">Makam : <?= $row->nama_makam ?></span>
                                </div>
            ...
            <div class="col-lg-3 col-12 col-custom">
                ...
                <aside class="sidebar_widget widget-mt">
                    <div class="widget_inner">
                        ...
                        <div class="widget-list widget-mb-1">
                            <h3 class="widget-title">Makam</h3>
                            <!-- Widget Menu Start -->
                            <nav>
                                <ul class="mobile-menu p-0 m-0">
                                    <?php foreach($makam as $res){ ?>
                                    <li class="menu-item-has-children"><a href="<?= base_url('dashboard/makam_detail/'.$res->id_makam) ?>"><?= $res->nama_makam ?></a>
                        ...
                        <div class="widget-list widget-mb-3">
                            ...
                            <div class="sidebar-body">
                                <ul class="tags">
                                    ...
                                    <li><a href="<?= base_url('home/makam/kategori_restoran/'.$rk->id_kategori) ?>"><?= $rk->nama_kategori ?></a></li>
                                    <?php } ?>
                                </ul>
                            </div>
                        </div>
                        <div class="widget-list widget-mb-4">
                            ...
                            <div class="sidebar-body">
                                <?php $menu = $this->db->get('paket',3)->result(); ?>
                                <?php foreach($menu as $m){ ?>
                                <div class="sidebar-product align-items-center">
                                    <a href="<?= base_url('dashboard/paket_detail/'.$row->id_paket) ?>" class="image">
                                        <img src="<?= base_url('assets/uploads/paket/'.$m->foto) ?>" alt="product">
                                    </a>
                                    <div class="product-content">
                                        <div class="product-title">
                                            <h4 class="title-2"> <a href="<?= base_url('dashboard/paket_detail/'.$row->id_paket) ?>"><?= $m->nama_paket ?></a></h4>
                                        </div>
                                        <div class="price-box">
