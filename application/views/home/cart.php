                        ...
                        <table class="table table-bordered">
                            ...
                            <tbody>
                                ...
                                foreach ($order as $row) { ?>
                                    ...
                                    <tr>
                                        <td class="pro-title"><a href="<?= base_url('dashboard/paket_detail/' . $row['id']) ?>"><?= $row['name'] ?></a></td>
                                        <td class="pro-price"><?= $row['qty'] ?></a></td>
                                        <td class="pro-price"><span>Rp. <?= number_format($row['price'], 0, ',', '.') ?></span></td>
                                        <td>
                                            <a href="<?= base_url('home/cart/remove/') . $row['rowid'] ?>" class="btn bg-danger pl-2 pr-2">
                                                <span>HAPUS</span>
                                            </a>
                                        </td>
                                    </tr>
        ...
        <div class="row">
            <div class="col-lg-12 ml-auto">
                ...
                <div class="cart-calculator-wrapper">
                    ...
                    <a href="<?= base_url('home/checkout') ?>" class="btn obrien-button primary-btn">Checkout</a>
                </div>
            </div>
        </div>
    </div>
