...
<div class="carousel" style="background-image: url('<?= base_url('assets/') ?>bege.png')">
    <div class="container">
        ...
        <a class="obrien-button primary-btn" href="#paket">Booking Sekarang</a>
    </div>
        ...
        <div class="row">
            <div class="col-lg-5 col-custom m-auto text-center">
                <div class="section-content">
                    ...
                    <p>Pilih Paket Pelayanan Pemakaman yang Anda Inginkan</p>
                </div>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="single-item">
                            <div class="single-product position-relative mb-30">
                                <div class="product-image">
                                    <a class="d-block" href="<?= base_url('home/checkout/tambah_cart/' . $row->id_paket) ?>">
                                ...
                                <div class="product-content" style="height: 200px;">
                                    <div class="product-title">
                                        <br>
                                        <h4 class="title-2"> <a href="<?= base_url('home/checkout/tambah_cart/' . $row->id_paket) ?>">Rp. <?= number_format($row->harga, 0, ',', '.'); ?></a></h4><br>
