...
class Transaksi extends CI_Controller {
	...
	public function index()
	{
		...
		$data['transaksi'] = $this->db->query("SELECT * FROM transaksi t, users u, paket f, makam r WHERE t.id_users=u.id_users AND t.id_paket=f.id_paket AND t.id_makam=r.id_makam ORDER BY id_transaksi DESC")->result();
